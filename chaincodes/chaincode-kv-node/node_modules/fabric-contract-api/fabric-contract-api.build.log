...
> fabric-contract-api@2.5.2 lint
> eslint ./lib/


> fabric-contract-api@2.5.2 test:unit
> npm run test


> fabric-contract-api@2.5.2 test
> nyc mocha --recursive 'test/unit/**/*.js'
  ...
  Default.js
    Default
2023-01-25T17:29:19.426Z info [c-api:./lib/annotations/default.js]                @Default args: "Target ->","mockTarget" 
      ✔ should add set value for default when none set
2023-01-25T17:29:19.436Z info [c-api:./lib/annotations/default.js]                @Default args: "Target ->","mockTarget" 
      ✔ should error when default already set

  Info.js
    Info
2023-01-25T17:29:19.440Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when no objects exist for global yet
2023-01-25T17:29:19.443Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when objects exist for global
    Info with data
2023-01-25T17:29:19.445Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when no objects exist for global yet
2023-01-25T17:29:19.456Z info [c-api:./lib/annotations/info.js]                   @Info args: "Info -> [object Object],","Target ->","steve" 
      ✔ should add object as key when objects exist for global

  Object.js
    #Object
2023-01-25T17:29:19.460Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object as key when no objects exist for global yet
2023-01-25T17:29:19.477Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object as key when objects exist for global
2023-01-25T17:29:19.479Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
      ✔ should add object with no supertype
2023-01-25T17:29:19.482Z info [c-api:./lib/annotations/object.js]                 @Object args: Target -> %s "Function" 
  ...
  Transaction.js
    Transaction
2023-01-25T17:29:19.497Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should handle existing transactions
2023-01-25T17:29:19.503Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should error if missing type
2023-01-25T17:29:19.515Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should handle existing transactions of which matches name and already has param metadata
2023-01-25T17:29:19.519Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> true,","Target ->","Object" 
      ✔ should create new metadata for fabric:transactions if none exist and handle no params
2023-01-25T17:29:19.521Z info [c-api:./lib/annotations/transaction.js]            @Transaction args: "Property Key -> mockKey, Commit -> false,","Target ->","Object" 
      ✔ should not add a tag if commit is false
    Returns
2023-01-25T17:29:19.527Z info [c-api:./lib/annotations/transaction.js]            @Returns args: ", Property Key -> mockKey, Return Type -> someType,","Target ->","Object" 
      ✔ should handle existing transactions
2023-01-25T17:29:19.530Z info [c-api:./lib/annotations/transaction.js]            @Returns args: ", Property Key -> mockKey, Return Type -> someType,","Target ->","Object" 
      ✔ should handle when there are no existing transactions
    Param
2023-01-25T17:29:19.533Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should overwrite when the transaction exists and param of name already in
2023-01-25T17:29:19.537Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should overwrite existing transaction but add new param when one with name does not exist
2023-01-25T17:29:19.540Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should append to transaction a new parameters array when transaction exists but has not parameters field
2023-01-25T17:29:19.543Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> some description,","Target ->","Object" 
      ✔ should handle when no transaction exists
2023-01-25T17:29:19.548Z info [c-api:./lib/annotations/transaction.js]            @Param args: "Property Key -> mockKey, Param Name -> some param, Param Type -> some type, Description -> undefined,","Target ->","Object" 
...
2023-01-25T17:29:19.569Z error [c-api:./lib/contract.js]                          [some id] Contract contract-api.Contract unknown transaction "wibble", 
...
2023-01-25T17:29:19.591Z error [c-api:./lib/jsontransactionserializer.js]         undefined toBuffer validation against schema failed on type "number","string" 
...
2023-01-25T17:29:19.611Z error [c-api:./lib/jsontransactionserializer.js]         undefined fromBuffer no data supplied  
      ✔ should throw an error if nothing given
      ✔ should throw an error if not a number
      ✔ should throw an error if bad boolean given
2023-01-25T17:29:19.615Z error [c-api:./lib/jsontransactionserializer.js]         fromBuffer could not parse data as JSON to allow it to be converted to type: "some type" "trie",{} 
2023-01-25T17:29:19.616Z error [c-api:./lib/jsontransactionserializer.js]         Converting data to string and JSON.stringify-ing  
  ...
  Logger
    ✔ coverage
2023-01-25T17:29:19.634Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
2023-01-25T17:29:19.634Z error [c-api:_]                                          Unhandled Rejection reason __PERMITTED__ promise Promise { <rejected> '__PERMITTED__' }  
    getLogger
...
> fabric-contract-api@2.5.2 test:schema
