...
export class StaticCollectionConfig extends jspb.Message {
  ...
  getEndorsementPolicy(): common_policies_pb.ApplicationPolicy | undefined;
  setEndorsementPolicy(value?: common_policies_pb.ApplicationPolicy): void;
...
export namespace StaticCollectionConfig {
  export type AsObject = {
    ...
    endorsementPolicy?: common_policies_pb.ApplicationPolicy.AsObject,
  }
}
