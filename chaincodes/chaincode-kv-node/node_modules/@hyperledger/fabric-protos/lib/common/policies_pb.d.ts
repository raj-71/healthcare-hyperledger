...
export class ImplicitMetaPolicy extends jspb.Message {
  ...
  getRule(): ImplicitMetaPolicy.RuleMap[keyof ImplicitMetaPolicy.RuleMap];
  setRule(value: ImplicitMetaPolicy.RuleMap[keyof ImplicitMetaPolicy.RuleMap]): void;
...
export namespace ImplicitMetaPolicy {
  export type AsObject = {
    subPolicy: string,
    rule: ImplicitMetaPolicy.RuleMap[keyof ImplicitMetaPolicy.RuleMap],
  }
...
export class ApplicationPolicy extends jspb.Message {
  ...
  setSignaturePolicy(value?: SignaturePolicyEnvelope): void;
